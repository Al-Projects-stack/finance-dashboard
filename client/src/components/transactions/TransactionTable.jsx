              ...
              {transactions.map((t) => (
                <tr key={t.id} className={styles.row}>
                  ...
                  <td className={styles.actions}>
                    ...
                    >
                      {deleting === t.id
                        ? <span style={{ width: 15, height: 15, borderRadius: '50%', border: '2px solid currentColor', borderTopColor: 'transparent', display: 'inline-block', animation: 'spin 0.6s linear infinite' }} />
                        : <TrashIcon />}
                    </button>
                  </td>
                </tr>
